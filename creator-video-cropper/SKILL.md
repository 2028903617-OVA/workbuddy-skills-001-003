---
name: video-cropper
description: Crop videos to focus on the most important area for social,
  ecommerce, ads, and storefront use without making the result look clumsy. Use
  when the frame includes wasted space, wrong composition, or unnecessary edges.
---
